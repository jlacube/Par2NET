...
namespace CommandLine
{
    ...
    public sealed class Parser
    {
        ...
        public static bool ParseArgumentsWithUsage(string[] arguments, object destination, Type castingType)
        {
            if (Parser.ParseHelp(arguments) || !Parser.ParseArguments(arguments, destination, castingType))
            {
                // error encountered in arguments. Display usage message
                System.Console.Write(Parser.ArgumentsUsage(castingType.GetType()));
                return false;
            }
        ...
        public static bool ParseArguments(string[] arguments, object destination, Type castingType)
        {
            return Parser.ParseArguments(arguments, destination, castingType, new ErrorReporter(Console.Error.WriteLine));
        }
        ...
        public static bool ParseArguments(string[] arguments, object destination, Type castingType, ErrorReporter reporter)
        {
            Parser parser = new Parser(castingType, reporter);
            return parser.Parse(arguments, destination);
        }
